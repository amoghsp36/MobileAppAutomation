...
public class ServerManager {
    ...
    private void build(){
        AppiumServiceBuilder appiumServiceBuilder = new AppiumServiceBuilder().usingAnyFreePort();
    ...
    public URL start(){
        ...
        await().atMost(Duration.ofSeconds(5)).until(appiumDriverLocalServiceThreadLocal.get()::isRunning);
